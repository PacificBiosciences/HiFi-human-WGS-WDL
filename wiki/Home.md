...
1) Download the release zips directly from a [supported release](https://github.com/PacificBiosciences/HiFi-human-WGS-WDL/releases/tag/v2.0.0):

  ```bash
  wget https://github.com/PacificBiosciences/HiFi-human-WGS-WDL/releases/download/v2.0.0/hifi-human-wgs-singleton.zip
  wget https://github.com/PacificBiosciences/HiFi-human-WGS-WDL/releases/download/v2.0.0/hifi-human-wgs-family.zip
  ```
...
| Engine | [Azure](./backend-azure) | [AWS](./backend-aws-healthomics) | [GCP](./backend-gcp) | [HPC](./backend-hpc) |
| :- | :- | :- | :- | :- |
...
Tool versions and Docker images used in these workflows can be found in the [tools and containers](./tools_containers) documentation.
