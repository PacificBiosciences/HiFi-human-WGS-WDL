...
- Docker images used by these workflows are defined in [the HiFi-human-WGS-WDL repo](https://github.com/PacificBiosciences/HiFi-human-WGS-WDL). Images are hosted in PacBio's [quay.io](https://quay.io/organization/pacbio).
