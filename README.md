...
This is an actively developed workflow with multiple versioned releases, and we make use of git submodules for common tasks that are shared by multiple workflows. To ensure that the submodules are correctly initialized:

Clone the repository and initialize the submodules:

  ```bash
  git clone \
    --depth 1 --branch v1.2.0 \
    --recursive \
...
| hiphase | <ul><li>[HiPhase 1.4.4](https://github.com/PacificBiosciences/HiPhase/releases/tag/v1.4.4)</li><li>[samtools 1.20](https://github.com/samtools/samtools/releases/tag/1.20)</li><li>[bcftools 1.20](https://github.com/samtools/bcftools/releases/tag/1.20)</li></ul> | [Dockerfile](https://github.com/PacificBiosciences/wdl-dockerfiles/tree/0ab8c2ba1c4fead5eac00d3470e20fd09bef3517/docker/hiphase) |
...
| svpack | <ul><li>[svpack 9dddda6](https://github.com/PacificBiosciences/svpack/tree/9dddda61e7c8e81124d35478600ad13e4db8d612)</li><li>[htslib 1.20](https://github.com/samtools/htslib/releases/tag/1.20)</li><li>[pysam 0.22.1](https://github.com/pysam-developers/pysam/releases/tag/v0.22.1)</li> | [Dockerfile](https://github.com/PacificBiosciences/wdl-dockerfiles/tree/6b13cc246dd44e41903d17a660bb5432cdd18dbe/docker/svpack) |
